...
console.log ("Sesión de Arreglos y Bucles")

/*========================================================
ARRAYS 
====================================================

Un array es algo donde ponemos elementos
Se puede declarar de multiples tipos, como strings o booleanos
Se recomienda que sean del mismo tipo
*/
const nyArray = [true, 42, "Hola", null]

//Se recomienda que el nombre del array sea en plural

//Se recomienda que se declare con const para que esa
//caja no cambie su valor
// --- 1. Definición ---
